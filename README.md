...
samurai-native enables you to build smooth user experience native apps using web technologies (HTML/CSS) based on its own Web-Core. Support iOS now, Android later.
